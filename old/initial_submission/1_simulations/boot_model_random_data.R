...
system.time(res<-bplapply(noms,function(x){
  res <- fastboot.fun(x,yi,dades,covari=NULL,log=FALSE,R=1000,meth="case")
  data.frame(res)
...
write.table(res,file=paste(output.path,"/res_fastboot.fun_CASC_",log.op,"_1batch.tsv",sep=""),
