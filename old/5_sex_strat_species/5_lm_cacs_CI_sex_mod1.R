...
dades=dades[,c("casctot","agev1","gender","siteid","q005a","plate",grep("____mgs",names(dades),value=T),noms)]

yi="casctot"
covari=c("agev1","siteid","siteid:plate","q005a","shannon____mgs")
...
#export
write.table(res,file=paste(output.path,"/res_cacs_mgs_basic_model_sex_strat.tsv",sep=""),
