/*Code for running ordinal mixed models for plaque, SIS, Duke.
...
keep `VList' sis stenosis athero plaque cacstot_cat age carb protein fiber sbp dbp ///
		...
		bp_med site_plate* family duke sis plaque
...
***********Running models********************************	
foreach v2 of varlist duke sis plaque{
	...
	foreach var of varlist hg*{
		noi di "`var'"
		if "`v2'"!="cacstot_cat" cap xtologit `v2' `var' age carb protein fiber sbp dbp ///
